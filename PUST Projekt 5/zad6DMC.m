function [ E ] = zad6DMC(D,N,Nu,lambda,psi,draw,latex)
D=round(D);
N=round(N);
Nu=round(Nu);
load('sU1Y1.txt');
...
if(latex)
    foldername=sprintf('dmc_skrot_%d_%d_%d/%3.4f_%3.4f_%3.4f_%3.4f_%3.4f_%3.4f_%3.4f',D,N,Nu,psi(1),psi(2),psi(3),lambda(1),lambda(2),lambda(3),lambda(4));
    mkdir(foldername);
