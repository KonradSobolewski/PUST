...
Pierwszym poleceniem by³o zweryfikowanie poprawnoœci punktu pracy obiektu. Uda³o siê to osi¹gn¹æ za pomoc¹ prostego sprawdzenia, przy jakich wartoœciach wyjœæ stabilizuje siê obiekt przy sta³ym sterowaniu, równym jego wartoœci w punkcie pracy ($U1_{pp}=0$, $U2_{pp}=0$, $U3_{pp}=0$, $U4_{pp}=0$). Eksperyment potwierdzi³ wczeœniej podane wartoœci wyjœæ ($Y1_{pp}=0$, $Y2_{pp}=0$, $Y3_{pp}=0$), a jego przebieg obrazuje wykres \ref{fig:punktpracy}.
