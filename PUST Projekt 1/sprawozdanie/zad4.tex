...
W projektowanych regulatorach $PID$ i $DMC$ zosta³y zastosowane nastêpuj¹ce ograniczenia:
\begin{equation}
...
$K$ - wzmocnienie cz³onu P , $T_p$ - czas próbkowania, $T_i$ - czas zdwojenia cz³onu ca³kuj¹cego $I$, $T_d$ - czas wyprzedzenia cz³onu ró¿niczkuj¹cego $D$. 
\begin{equation}
...
\label{r2}
\end{equation}
W ka¿dej iteracji pêtli sterowania jest obliczany uchyb wyjœcia obiektu od wartoœæ zadanej jego wyjœcia.
\begin{equation}
