...
if(latex)
    ...
    toPlotForLatex(sprintf('z7dmcy1_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,y(1,:))
    toPlotForLatex(sprintf('z7dmcy2_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,y(2,:))
    toPlotForLatex(sprintf('z7dmcyzak1_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,yzak(1,:))
    toPlotForLatex(sprintf('z7dmcyzak2_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,yzak(2,:))
    toPlotForLatex(sprintf('z7dmcyzad1_%3.4f',yzad(1,kk)),1:kk,yzad(1,:))
    toPlotForLatex(sprintf('z7dmcyzad2_%3.4f',yzad(2,kk)),1:kk,yzad(2,:))
end
end