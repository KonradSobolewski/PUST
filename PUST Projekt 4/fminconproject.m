...
x0=[100 100 10 10 0.5];
lb=[1 1 0 0 0];
ub=[100 100 Inf Inf Inf Inf];
[nastawy, min_error]=fmincon(@(x)(p6DMC(x(1),x(2),x(3),2,x(5),x(6),false)),x0,[],[],[],[],lb,ub)
E=p6DMC(nastawy(1),nastawy(2),nastawy(3),2,nastawy(4),nastawy(5),false)