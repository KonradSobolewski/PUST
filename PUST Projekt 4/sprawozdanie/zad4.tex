...
\end{itemize}
Niestety zmiany zachodz¹ce na wykresach s¹ tutaj tak¿e niezauwa¿alne z tego wzglêdu nie zosta³y one tutaj udokumentowane. Do dalszych obserwacji wykorzystujemy wartoœæ $N_u = 3$, gdy¿ posiada najmniejszy wskaznik jakoœci. \\
...
W œwietle otrzymanych wyników stwierdzamy, ¿e zwyk³y algorytm DMC, tak¿e jest nieskuteczny przy nielinowym obiekcie. 
