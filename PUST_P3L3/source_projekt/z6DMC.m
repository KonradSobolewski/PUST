...
if(latex)
    toPlotForLatex(sprintf('z6dmcu1_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E1,n),1:kk,u(1,:))
    toPlotForLatex(sprintf('z6dmcu2_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E2,n),1:kk,u(2,:))
    toPlotForLatex(sprintf('z6dmcy1_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,y(1,:))
    toPlotForLatex(sprintf('z6dmcy2_%d_%d_%3.4f_%3.4f_%d',N,Nu,lambda,E,n),1:kk,y(2,:))
