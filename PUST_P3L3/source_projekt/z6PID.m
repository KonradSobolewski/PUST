...
%eksport dla latexa
if(latex)
    toPlotForLatex(sprintf('z6pidu1_%d_%3.4f_%3.4f_%3.4f_%3.4f_%3.4f_%d',var,K1,Ti1,Td1,E1,E,n),1:kk,u(1,:))
    toPlotForLatex(sprintf('z6pidu2_%d_%3.4f_%3.4f_%3.4f_%3.4f_%3.4f_%d',var,K2,Ti2,Td2,E2,E,n),1:kk,u(2,:))
    toPlotForLatex(sprintf('z6pidy1_%d_%3.4f_%3.4f_%3.4f_%3.4f_%d',var,K1,Ti1,Td1,E,n),1:kk,y(1,:))
    toPlotForLatex(sprintf('z6pidy2_%d_%3.4f_%3.4f_%3.4f_%3.4f_%d',var,K2,Ti2,Td2,E,n),1:kk,y(2,:))
